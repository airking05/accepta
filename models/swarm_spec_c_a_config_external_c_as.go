...
// SwarmSpecCAConfigExternalCAs Configuration for forwarding signing requests to an external certificate authority.
// swagger:model swarmSpecCAConfigExternalCAs
