...
// TaskSpecContainerSpecMounts Specification for mounts to be added to containers created as part of the service.
// swagger:model taskSpecContainerSpecMounts
