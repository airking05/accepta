...
// ServiceSpecNetworksItems service spec networks items
// swagger:model serviceSpecNetworksItems
...
func (m *ServiceSpecNetworksItems) validateAliases(formats strfmt.Registry) error {
...
func (m *ServiceSpecNetworksItems) UnmarshalBinary(b []byte) error {
	var res ServiceSpecNetworksItems
