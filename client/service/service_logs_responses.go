...
func (o *ServiceLogsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 101:
		result := NewServiceLogsSwitchingProtocols(o.writer)
...
func NewServiceLogsSwitchingProtocols(writer io.Writer) *ServiceLogsSwitchingProtocols {
	return &ServiceLogsSwitchingProtocols{
		Payload: writer,
	}
}
...
func (o *ServiceLogsSwitchingProtocols) Error() string {
	return fmt.Sprintf("[GET /services/{id}/logs][%d] serviceLogsSwitchingProtocols  %+v", 101, o.Payload)
}

func (o *ServiceLogsSwitchingProtocols) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
