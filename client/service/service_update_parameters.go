...
func (o *ServiceUpdateParams) WithBody(body *models.ServiceUpdateParamsBody) *ServiceUpdateParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the service update params
func (o *ServiceUpdateParams) SetBody(body *models.ServiceUpdateParamsBody) {
	o.Body = body
}
