...
func (o *ServiceCreateParams) WithBody(body *models.ServiceCreateParamsBody) *ServiceCreateParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the service create params
func (o *ServiceCreateParams) SetBody(body *models.ServiceCreateParamsBody) {
	o.Body = body
}
