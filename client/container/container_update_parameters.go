...
func (o *ContainerUpdateParams) WithUpdate(update *models.ContainerUpdateParamsBody) *ContainerUpdateParams {
	o.SetUpdate(update)
	return o
}

// SetUpdate adds the update to the container update params
func (o *ContainerUpdateParams) SetUpdate(update *models.ContainerUpdateParamsBody) {
	o.Update = update
}
