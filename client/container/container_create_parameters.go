...
func (o *ContainerCreateParams) WithBody(body *models.ContainerCreateParamsBody) *ContainerCreateParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the container create params
func (o *ContainerCreateParams) SetBody(body *models.ContainerCreateParamsBody) {
	o.Body = body
}
